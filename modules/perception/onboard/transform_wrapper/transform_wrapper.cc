...
void TransformWrapper::Init(
  ...
  /**
   * FLAGS_obs_sensor2novatel_tf2_frame_id在下面文件中定义
   ...
   * 实际上惯导"novatel"即为车自身坐标系
   * **/    
  sensor2novatel_tf2_frame_id_ = FLAGS_obs_sensor2novatel_tf2_frame_id;

  /**
   * 传感器坐标系sensor2novatel_tf2_child_frame_id_由传入参数指定
   * 最终的效果是得到该传感到"novatel"的坐标转换，即到车自身坐标系的转换关系
   * **/
  sensor2novatel_tf2_child_frame_id_ = sensor2novatel_tf2_child_frame_id;

  /**
   * FLAGS_obs_novatel2world_tf2_frame_id在下面文件中定义
   * modules/perception/onboard/transform_wrapper/transform_wrapper.cc
   * 默认值
   * DEFINE_string(obs_novatel2world_tf2_frame_id, "world",
   *           "novatel to world frame id");
   ...
   * 
   * 所以
   * novatel2world_tf2_child_frame_id_=novatel"
   * **/
