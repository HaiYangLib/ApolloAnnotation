...
bool SensorManager::Init() {
  ...
  /**
   * FLAGS_obs_sensor_meta_path在下面文件中定义
  ...
  /**
   * MultiSensorMeta和SensorMeta在下面文件中定义
   ...
   * }
   *
   * sensor_info_map_保存这很多sensor_meta
   * ...................
   * **/
  auto AddSensorInfo = [this](const SensorMeta& sensor_meta_proto) {
    ...
    if (this->IsCamera(sensor_info.type)) {
      ...
      // distort_model->get_camera_model()返回一个PinholeCameraModel    
