...
### 步骤3：调整ReferenceLine长度

调整ReferenceLine和RouteSegments长度
...
`ReferenceLineInfo`在函数`Frame::CreateReferenceLineInfo`构造
...
![image-20220215130030125](assets/自动驾驶导论.assets/image-20220215130030125.png)
...
7. 优选出cost最小的trajectory,具体实现下文会讲解
...
![image-20220216004920787](assets/自动驾驶导论.assets/image-20220216004920787.png)
...
[Cartesian 坐标系与Frenet坐标系的转换](https://www.jianshu.com/p/630c19f2bb9a)
...
[Optimal Trajectory Generation for Autonomous Vehicles Under Centripetal Acceleration Constraints for In-lane Driving Scenarios](https://arxiv.org/abs/2112.02133)

[Baidu Apollo代码解析之path_bounds_decider](https://zhuanlan.zhihu.com/p/112571436)

[Lattice Planner规划算法原理](https://zhuanlan.zhihu.com/p/399545248)
