...
![image-20220410144942357](assets/自动驾驶导论.assets/image-20220410144942357.png)
...
产生关于$l$ 的限制条件,为下一步的`PiecewiseJerkPathOptimizer`做准备
...
约束函数
$$
s\left(t_{0}\right)=c_{6}=s_{0}
$$
$$
\begin{aligned}
&v\left(t_{0}\right)=c_{5}=t s_{0} \\
&a\left(t_{0}\right)=2 c_{4}=t t s_{0}
\end{aligned}
$$
$$
\begin{aligned}
&s\left(t_{1}\right)=c_{1} t_{1}^{5}+c_{2} t_{1}^{4}+c_{3} t_{1}^{3}+c_{4} t_{1}^{2}+c_{5} t_{1}+c_{6}=s_{1} \\
&v\left(t_{1}\right)=5 c_{1} t_{1}^{4}+4 c_{2} t_{1}^{3}+3 c_{3} t_{1}^{2}+2 c_{4} t_{1}+c_{5}=t s_{1} \\
&a\left(t_{1}\right)=20 c_{1} t_{1}^{3}+12 c_{2} t_{1}^{2}+6 c_{3} t_{1}+2 c_{4}=t t s_{1}
\end{aligned}
$$
解方程组, 即可得到多项式系数。
...
&v(t)=4 b_{1} t^{3}+3 b_{2} t^{2}+2 b_{3} t+b_{4} \\
&a(t)=12 b_{1} t^{2}+6 b_{2} t+2 b_{3}
\end{aligned}
$$
约束函数
$$
\begin{aligned}
&s\left(t_{0}\right)=b_{5}=s_{0} \\
&v\left(t_{0}\right)=b_{4}=t s_{0} \\
&a\left(t_{0}\right)=2 b_{3}=t t s_{0} \\
&v\left(t_{1}\right)=4 b_{1} t_{1}^{3}+3 b_{2} t_{1}^{2}+2 b_{3} t_{1}+b_{4}=t s_{1} \\
&a\left(t_{1}\right)=12 b_{1} t_{1}^{2}+6 b_{2} t_{1}+2 b_{3}=t t s_{1}
\end{aligned}
$$
解方程组, 即可得到多项式系数。
...
$d_{0}$ 初始状态的横向偏移量。
$s d_{0}$ 初始状态的横向偏移速度。
$s s d_{0}$ 初始状态的横向偏移加速度。
$d_{1}$ 采样状态的横向偏移量。
$s d_{1}$ 采样状态的横向偏移速度。
$s s d_{1}$ 采样状态的横向偏移加速度。
$s_{0}$ 初始状态下的纵向位移。
$s_{1}$ 采样状态下的纵向位移。其中, 巡航模式下 $s_{1}=s\left(t_{1}\right)$ 。
...
&d_{v}(t)=5 k_{1} s^{4}+4 k_{2} s^{3}+3 k_{3} s^{2}+2 k_{4} s+k_{5} \\
&d_{a}(s)=20 k_{1} s^{3}+12 k_{2} s^{2}+6 k_{3} s+2 k_{4}
\end{aligned}
$$
约束函数：
$$
\begin{aligned}
&d\left(s_{0}\right)=k_{1} s_{0}^{5}+k_{2} s_{0}^{4}+k_{3} s_{0}^{3}+k_{4} s_{0}^{2}+k_{5} s_{0}+k_{6}=d_{0} \\
&d_{v}\left(s_{0}\right)=5 k_{1} s_{0}^{4}+4 k_{2} s_{0}^{3}+3 k_{3} s_{0}^{2}+2 k_{4} s_{0}+k_{5}=s d_{0} \\
&d_{a}\left(s_{0}\right)=20 k_{1} s_{0}^{3}+12 k_{2} s_{0}^{2}+6 k_{3} s_{0}+2 k_{4}=s s d_{0} \\
&d\left(s_{1}\right)=k_{1} s_{1}^{5}+k_{2} s_{1}^{4}+k_{3} s_{1}^{3}+k_{4} s_{1}^{2}+k_{5} s_{1}+k_{6}=d_{1} \\
&d_{v}\left(s_{1}\right)=5 k_{1} s_{1}^{4}+4 k_{2} s_{1}^{3}+3 k_{3} s_{1}^{2}+2 k_{4} s_{1}+k_{5}=s d_{1} \\
&d_{a}\left(s_{1}\right)=20 k_{1} s_{1}^{3}+12 k_{2} s_{1}^{2}+6 k_{3} s_{1}+2 k_{4}=s s d_{1}
\end{aligned}
$$
解方程组, 即可得到多项式系数。
